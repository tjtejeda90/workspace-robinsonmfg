...
cprequire_test(["inline:com-chilipeppr-workspace-robinsonmfg"], function(ws) {
    ...
    $('title').html("Robinson Mfg Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-robinsonmfg", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-robinsonmfg", // Make the id the same as the cpdefine id
        name: "Workspace / Robinson Mfg", // The descriptive name of your widget.
        desc: `This is a workspace for Robinson Mfg.`,
